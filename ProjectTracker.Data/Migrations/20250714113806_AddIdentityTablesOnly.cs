...
namespace ProjectTracker.Data.Migrations
{
    ...
    public partial class AddIdentityTablesOnly : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserProjects_UserId_CanView",
                table: "UserProjects",
                columns: new[] { "UserId", "CanView" });
        ...
        {
            // Önce foreign key'leri olan tabloları sil
            ...
            // ❌ AŞAĞIDAKİLERİ SİLİN - Bu tablolar zaten vardı, biz oluşturmadık
            // migrationBuilder.DropTable(name: "MaintenanceLogs");
            // migrationBuilder.DropTable(name: "ProjectEmployees");
            // migrationBuilder.DropTable(name: "WorkLogAttachments");
            // migrationBuilder.DropTable(name: "WorkLogDetails");
