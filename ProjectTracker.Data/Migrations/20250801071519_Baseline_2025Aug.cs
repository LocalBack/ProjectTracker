...
{
    /// <inheritdoc />
    public partial class Baseline_2025Aug : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipments_Projects_ProjectId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserProjects_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkLogAttachments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkLogAttachments_WorkLogs_WorkLogId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TechnicalDetails = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkLogDetails", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkLogDetails_WorkLogs_WorkLogId",
                        column: x => x.WorkLogId,
                        principalTable: "WorkLogs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectEmployees_ProjectId_IsActive",
                table: "ProjectEmployees",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkLogAttachments_WorkLogId",
                table: "WorkLogAttachments",
                column: "WorkLogId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkLogDetails_WorkLogId",
                table: "WorkLogDetails",
                column: "WorkLogId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkLogs_ProjectId_EmployeeId",
                table: "WorkLogs",
